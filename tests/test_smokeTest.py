...
class TestSmokeTest():
  ...
  def test_joinpage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Bernard")
    self.driver.find_element(By.NAME, "lname").send_keys("Michael")
    self.driver.find_element(By.NAME, "bizname").send_keys("Bspn")
